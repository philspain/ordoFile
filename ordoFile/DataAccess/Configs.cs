...
namespace ordoFile.DataAccess
{
    ...
    {
        //Static instance of Configs for use as singleton return value
        static Configs _configInstance;

        //Decides whether or not the background process can run
        bool _bgDirectoryExists;
        ...
        {
            get { return _bgDirectoryExists; }
            set
            {
                _bgDirectoryExists = value;
            }
        }
        ...
        public string BGDirectory
        {
            ...
            set
            {
                _bgDirectoryExists = Directory.Exists(value);
                _bgDirectory = value;
        ...
        /// </summary>
        /// <returns>Returns an instance of Configs.</returns>
        public static Configs GetConfigs()
        {
            if (_configInstance == null)
            {
                _configInstance = new Configs();
            }
...
<xs:schema xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
    <config>
        ...
        /// <returns>Returns a string value for chosen setting</returns>
